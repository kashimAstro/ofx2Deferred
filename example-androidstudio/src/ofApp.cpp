...
void ofApp::setup(){
    ...
    gui.setup();
    gui.add(position.set("position",glm::vec2(0.5,0.5),glm::vec2(0.,0.),glm::vec2(1.,1.)));
    gui.add(size.set("size",0.02,-1.,1.));
    gui.add(focus.set("focus",-0.0099999,-1.,5.));
    gui.add(brightness.set("brightness",0.55,-1.,10.));
    gui.add(colors.set("colors",glm::vec4(1.0,0.0,1.0,1.0),glm::vec4(0.,0.,0.,0.),glm::vec4(1.,1.,1.,1.)));
